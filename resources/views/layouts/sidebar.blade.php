                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item open">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                            ...
                            <div data-i18n="Layouts">Afiiate</div>
                        </a>

                        <ul class="menu-sub" style="list-style-type: none">
                            <li class="menu-ite">
                                <a href="/platform-afiliate" class="menu-link">
                                    <div data-i18n="Without menu">Platform Afiliate</div>
                                </a>
                            </li>
                            <li class="menu-ite">
                                <a href="/produk-afiliate" class="menu-link">
                                    <div data-i18n="Without menu">Produk Afiliate</div>
                                </a>
                            </li>
