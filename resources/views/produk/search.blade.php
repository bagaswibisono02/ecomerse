                ...
                <div class=" col-5 product-item position-relative m-2" style="min-height: 380px">
                    <div class="productk-detail position-relative">
                        ...
                        <div class="position-relative p-2">
                            <div class="mt-2 me-2" > <a href="{{ route('detail.produk', ['slug'=> Str::slug($foryou->nama),'data' => Crypt::encrypt(['id' => encrypt($foryou->id) , 'nama' => $foryou->nama])]) }}" class="text-dark text-decoration-none"> {{ Str::limit($foryou->nama, 35, '...')  }}</a></div>
